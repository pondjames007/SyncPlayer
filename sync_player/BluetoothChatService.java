...
public class BluetoothChatService {
    ...
    private ArrayList<ConnectedThread> connectedArray;
    ...
    public BluetoothChatService(Context context, Handler handler) {
        ...
        connectedArray=new ArrayList<ConnectedThread>();
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        connectedArray.add(mConnectedThread);        
    ...
    public synchronized void stop() {
        ...
        //mHandler.obtainMessage(MESSAGE_CLOSE, -1, -1).sendToTarget();
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            try {
            for (int i = 0; i < BluetoothChatService.MAX_SUPPORTED; i++) {
                BluetoothServerSocket myServerSocket = mAdapter.listenUsingRfcommWithServiceRecord(NAME_INSECURE, mUuid.get(i));
            ...
            connected(myBSock, myBSock.getRemoteDevice(),mSocketType);
        ...
        public ConnectThread(BluetoothDevice device, boolean secure) {
            ...
            try {
                if (secure) {
                	...
                	for (int i = 0; i < BluetoothChatService.MAX_SUPPORTED && tmp == null; i++) {
                        for (int j = 0; j < 3 && tmp == null; j++) {
                            tmp = device.createInsecureRfcommSocketToServiceRecord( mUuid.get(i));
                            if (tmp == null) {
                                try {
                                    Thread.sleep(200);
